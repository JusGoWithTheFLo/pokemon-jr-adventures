...
const episodes = [
    ...
    },
    {
        ...
        text: ["<h1>Episode 9: Pokemon Hunting!</h1>",
            "<p><b class='ra'>You leave Viridian City behind and head out into the forest.  It isn't long before you come upon a field of tall grass.  Maybe there are Wild Pokemon here!  It would be great to catch another Pokemon to add to your team.</b></p>",
    ...
    },
    {
        ...
        text: ["<h1>Episode 10: Camp Out!</h1>",
            "<p><b class='ra'>You've been walking all day and now it is time to rest for the night.  You find a nice campsite just before the sun starts to set.</b></p>",
            "<img class='large-image' src='./images/path-evening.png'>",
            "<p><b class='ra'>The capsite is near a bubbling brook.  What else is around and near the campsite?</b></p>",
            ...
            "<p><b class='ra'>Just before darkness falls over the forest, you hear a voice call from far above you.  Up in the sky, you see a strange balloon.  It's shaped like that catlike Pokemon that was hanging out with Team Rocket.</b></p>",
            "<img class='large-image' src='./images/team-rocket-balloon.png'>",
            "<p><b class='ra'>As the balloon drifts by, you see that there are people in the basket that hands below it.  It's Team Rocket!</b></p>",
    ...
    },
    {
        ...
        text: ["<h1>Episode 11: Gary's Challenge!</h1>",
            ...
            "<p><b class='ra'>The next day Gary Oak, Professor Oak's grandson, waits for you along the forest path.</b></p>",
    ...
    },
    {
        ...
        text: ["<h1>Episode 12: Ambushed!</h1>",
            "<p><b class='ra'>The forest path winds peacefully between the trees.  It's a nice day.</b></p>",
            ...
            "<p><b class='ra'>\"Hey, I bet those Trainers have lots of rare and unusualy Pokemon.  Meowth!\" says Meowth.</b></p>",
